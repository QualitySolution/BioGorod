...
namespace BioGorod.Domain.Client
{
	...
	public class ContactAndPhonesView: PropertyChangedBase, IDomainObject
	{
		#region Свойства
		...
		#region свойства из view

		private string nameAndPhones;

		public virtual string NameAndPhones {
		    get { return nameAndPhones; }
		...
		public virtual string PhonesDigits {
		    get { return phonesDigits; }
		    set { SetField (ref phonesDigits, value, () => PhonesDigits); }
		}
