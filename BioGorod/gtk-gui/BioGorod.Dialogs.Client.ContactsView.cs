...
namespace BioGorod.Dialogs.Client
{
	public partial class ContactsView
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget BioGorod.Dialogs.Client.ContactsView
			global::Stetic.BinContainer.Attach (this);
			this.Name = "BioGorod.Dialogs.Client.ContactsView";
			// Container child BioGorod.Dialogs.Client.ContactsView.Gtk.Container+ContainerChild
