...
namespace BioGorod.Dialogs.Client
{
	public partial class DeliveryPointView
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget BioGorod.Dialogs.Client.DeliveryPointView
			global::Stetic.BinContainer.Attach (this);
			this.Name = "BioGorod.Dialogs.Client.DeliveryPointView";
			// Container child BioGorod.Dialogs.Client.DeliveryPointView.Gtk.Container+ContainerChild
